...
const Hero: React.FC = () => {
  return (
    <div className="  flex flex-col-reverse md:flex-row justify-evenly  m-4  md:px-8 pt-8 md:m-24 md:mt-12 space-x-2 align-center  text-center md:text-left  ">
      <div className="z-50  ml-4">
        ...
        <p className=" text-gray-400 text-sm md:text-base  text-left leading-normal w-full  md:w-[70%] md:mt-4 lg:text:xl ">{HERO_CONTENT}</p>
      </div>
      <img src={image1} alt="Hero" className="  w-[80%] self-center md:w-[40%] z-50  md:mr-12" />
    </div>
  );
};
