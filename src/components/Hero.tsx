  ...
  return (
    ...
    className="  flex flex-col-reverse md:flex-row justify-evenly  m-4  md:px-8 pt-8 md:m-24 md:mt-12 space-x-2 align-center  text-center md:text-left  2xl:mt-8">
      <div className="z-50  ml-4">
        ...
        initial="hidden"
        animate="visible"
        className="mb-2 "><span className=" bg-gradient-to-r from-pink-300 via-slate-500 to-purple-500 bg-clip-text text-2xl md:text-3xl tracking-tight text-transparent 2xl:text-5xl 2xl:mt-6">Front-end Developer </span> </motion.h2>
