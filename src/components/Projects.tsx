...
import ProjectModal from "./ProjectModal"; // Make sure to import your modal component
import { Project as ProjectModel } from "../constants/projects.ts";
        ...
        >
          {projects.map((project) => (
            <motion.div
              ...
              className={
                project.type === "mobile"
                  ? "group relative bg-white dark:bg-gray-800/50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700/50 flex flex-col sm:flex-row min-h-[220px] cursor-pointer"
                  : "group relative bg-white dark:bg-gray-800/50 rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 dark:border-gray-700/50 flex flex-col h-full cursor-pointer"
              }
