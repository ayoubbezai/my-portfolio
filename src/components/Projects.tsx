      ...
      >
        {info.map((project) => (
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            whileHover={{ y: -5 }}
            className="group relative bg-white dark:bg-gray-800/50 rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 dark:border-gray-700/50 hover:border-indigo-300/50 flex flex-col h-full"
          >
            {/* Image container - takes about 60% of card height */}
