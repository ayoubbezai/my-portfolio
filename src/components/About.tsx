...
const About = () => {
  return (
    <div className="mt-32 ">
      ...
      <div className="flex flex-col-reverse md:space-x-24 md:flex-row  justify-between  m-12 mt-2 mb-0  md:px-8 pt-8 md:mx-24 md:my-0  align-center  text-center md:text-left ">
        ...
        <img src={image2} alt="about" className="  w-[60%] self-center md:w-[40%] z-50 mr   md:mr-12 mb-8 rounded-xl"  />
      </div>
    </div>
  )
}
