...
const About = () => {
  return (
    <div className="mt-32 ">
      ...
      <div className="flex flex-col-reverse md:space-x-24 gap-x-11 md:flex-row  justify-between  m-4 mt-2 mb-0  md:px-8 pt-8 md:mx-24 md:my-0  align-center  text-center md:text-left ">
        <p className=" z-50 text-gray-400 text-sm text-left ml-3
           leading-relaxed w-[90%]  md:w-[70%] md:mt-4 2xl:text-xl">{ABOUT_TEXT}</p>
